...
namespace SmartSchool.WEBAPI.Data
{
    public class SmartContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            string dateString = "05/28/2005 12:00:00 PM";
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.Parse(dateString,culture)),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.Parse(dateString,culture)),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.Parse(dateString,culture)),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.Parse(dateString,culture)),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", DateTime.Parse(dateString,culture)),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", DateTime.Parse(dateString,culture)),
                    new Aluno(7, 7, "Paulo", "José", "9874512", DateTime.Parse(dateString,culture))
                });
